...
public class FindDoctorPageActions {
     ...
     * Author Name : Nikhith Sree Sai
     * Description : It passes department value to filter and performs click
     * operation
     * Return Type : NA
     * Params List : NA
     */
    ...
    public String retriveData(int row, int column) {
        try {
            return ExcelReader.readdata(System.getProperty("user.dir") + "/testdata/NikhithData.xlsx", "Sheet2", row,
                    column);
        } catch (Exception e) {
